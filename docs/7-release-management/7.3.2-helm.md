...
1. If you haven't already, clone the Engineering Bootcamp git repo on your local machine. This exercise will build off of the Helm chart in the `examples/ch7/helm/DKS` folder.
