...
You actually did deploy the `cert-manager` Helm Chart in this chapter... remember [this](9-kubernetes-container-orchestration/9.7-webhooks.md#setup)? However, in that case you only interacted with the chart imperatively by using the `helm` cli tool, and had very little insight into what was actually happening or getting deployed to your cluster.
...
<div class="quizdown">
  <div id="chapter-9/9.8.2/helm-quiz.js"></div>
</div>
