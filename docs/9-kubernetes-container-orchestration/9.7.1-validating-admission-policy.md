...
For this exercise we are going to recreate the Validation Webhook logic you created in [9.7](./9.7-webhooks.md), but this time with a ValidatingAdmissionPolicy.
...
<div class="quizdown">
  <div id="chapter-9/9.7.1/validatingadmissionpolicy-quiz.js"></div>
</div>
