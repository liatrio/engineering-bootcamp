...
Code for this exercise can be found in the [codeQuality/jest-mock repo](https://github.com/liatrio/engineering-bootcamp/tree/master/examples/codeQuality/jest-mock/mock.js ':include :type=code javascript')

## Exercise 1: Phonies

For this exercise, you will use **mocking** with Jest to test a GitHub user and repo checking program. The code now exposes only two user and two repo check functions.

[mock.js](https://github.com/liatrio/engineering-bootcamp/tree/master/examples/codeQuality/jest-mock/mock.js ':include :type=code javascript')
