...
1. Clone the bootcamp repository if you haven't already and navigate to the `examples/ch6/pre-commit-flask` folder for the test application that will be used throughout these exercises.
