...
?> Something to consider: is deploying k8s applications via terraform (ArgoCD or other) a good long term solution? Is it following proper GitOps principles? To fix this, once your platform is more developed consider trying to get ArgoCD to manage itself after it's initial install.
